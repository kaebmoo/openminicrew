...
| tool logs และ processed email metadata | minimized structured metadata | flow ใหม่พยายามหลีกเลี่ยงการเก็บ raw summaries เมื่อไม่จำเป็น |
...
- ลดการเก็บ processed email data ให้เหลือเท่าที่จำเป็น
