...
รันบน VPS (Oracle Cloud Free Tier ก็พอ) เก็บข้อมูลใน SQLite ไฟล์เดียว ค่าใช้จ่ายเกือบเป็นศูนย์ เราเป็นเจ้าของเซิร์ฟเวอร์ เป็นเจ้าของข้อมูล และเพิ่มเครื่องมือใหม่ได้แค่วางไฟล์ Python ไฟล์เดียวลงใน folder
